    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-1 text-2xl font-black text-white sm:text-3xl">Dashboard Laundry</h2>
                <p class="mt-1 text-sm text-stone-400">Pantau pengajuan, pembayaran, dan progres pesanan dari satu tempat.</p>
            </div>
