...
<head>
    ...
    <title>{{ config('app.name', 'LaundryPay') }} - Transaksi Laundry Digital</title>
    ...
    <div class="min-h-screen">
        <header class="sticky top-0 z-30 border-b border-white/10 bg-stone-950/90 backdrop-blur">
            <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                <a href="/" class="flex items-center gap-3" aria-label="LaundryPay home">
                    <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500 text-base font-black text-stone-950">LP</span>
                    <span class="leading-tight">
                        <span class="block text-base font-black tracking-tight sm:text-lg">LaundryPay</span>
                        <span class="hidden text-xs font-semibold text-stone-400 sm:block">Transaksi laundry digital</span>
                    </span>
                </a>
                ...
                <div class="mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
                    <div class="relative z-10">
                        <p class="inline-flex rounded-full border border-amber-300/20 bg-amber-300/10 px-4 py-2 text-sm font-bold text-amber-200">
                            Platform pesanan, kontrak, dan pembayaran
                        </p>
                        <h1 class="mt-6 max-w-3xl text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl lg:leading-[1.02]">
                            Kelola transaksi layanan laundry dengan lebih rapi.
                        </h1>
                        <p class="mt-5 max-w-2xl text-base leading-7 text-stone-300 sm:text-lg sm:leading-8">
                            Customer bisa mengajukan pesanan laundry, admin memvalidasi, pembayaran dicatat melalui invoice atau POS, lalu kontrak dibuat otomatis setelah lunas.
                        </p>
                    ...
                    <div class="relative z-10 mx-auto w-full max-w-md lg:max-w-none">
                        <div class="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-4 shadow-2xl shadow-black/30 sm:p-6">
                            ...
                            <div class="relative flex aspect-[4/3] items-center justify-center rounded-[1.5rem] bg-stone-900/80 p-6">
                                <img src="{{ asset('images/ijatawakal.jfif') }}" alt="Ilustrasi layanan laundry" class="h-full w-full object-contain drop-shadow-2xl" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div class="hidden h-full w-full items-center justify-center rounded-2xl border border-dashed border-amber-300/40 bg-amber-300/5 text-center text-sm font-bold leading-6 text-amber-100">
                                    Letakkan file PNG di<br>public/images/laundry-hero.png
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="alur" class="bg-stone-900 py-14 sm:py-16">
                <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        ...
                        <h2 class="mt-3 text-3xl font-black tracking-tight text-white sm:text-4xl">Empat langkah dari pengajuan sampai pesanan selesai.</h2>
                    </div>

                    <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        @foreach([
                            ['1', 'Ajukan', 'Customer mengisi detail cucian dan estimasi total.'],
                            ['2', 'Validasi', 'Admin meninjau pesanan laundry.'],
                            ['3', 'Bayar', 'Invoice atau POS mencatat pembayaran.'],
                            ['4', 'Selesai', 'Pesanan approved setelah pembayaran lunas.'],
                        ] as $step)
                ...
                <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div class="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
                        <div>
                            ...
                            <p class="mt-4 text-base leading-7 text-stone-300">Tanpa proses yang rumit, semua fitur diarahkan untuk membantu pencatatan pesanan laundry dan pembayaran.</p>
                        </div>

                        <div class="grid gap-4 sm:grid-cols-2">
                            @foreach([
                                ['Kontrak otomatis', 'Dokumen dibuat setelah pembayaran lunas.'],
        ...
        <footer class="border-t border-stone-800 bg-stone-950 py-8">
            <div class="mx-auto flex max-w-6xl flex-col gap-4 px-4 text-sm text-stone-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
                <p class="font-semibold text-white">LaundryPay</p>
                <p class="text-stone-400">Transaksi elektronik untuk layanan laundry.</p>
            </div>
        </footer>
    </div>
</body>
